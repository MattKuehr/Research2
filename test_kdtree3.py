...
def assign_bands_kdtree(omega_vals, k_neighbors=20):
        ...
        while stack:
            ...
            for idx in indices:
                if idx in unassigned_indices:
                    # To prevent jumping between bands, we could set a distance threshold
                    # But let's first see how pure connectivity works
